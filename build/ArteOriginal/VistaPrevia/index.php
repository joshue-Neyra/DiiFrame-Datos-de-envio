...
<head>
    <title>Arte Original - Vista Previa</title>
...
<body id="page-top">
    ...
    <input id="Producto_ID" class="d-none" value=" <?php echo $_GET['Prd_ID'];?>">
...
<script type="text/javascript" src="/assets/js/ArteOriginal/VistaPrevia.js"></script>
