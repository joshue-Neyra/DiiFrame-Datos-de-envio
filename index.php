        ...
        <div class="container">
            ...
            <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                <div class="col-xl-8 col-lg-7">
                    <img class="img-fluid mb-3 mb-lg-0" src="/assets/img/testimonial1.jpg" alt="">
                </div>
            ...
            <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="featured-text text-center text-lg-left">
                        ...
                        <p class="text-black-50 mb-0">Creemos en las opciones. Es por eso que le ofrecemos una amplia gama de marcos de fotos para elegir. Ya sea que desee vestir una imagen con un marco clásico, o vestirla y optar por una apariencia sin procesar usando uno de nuestros bordes de tiras de película, ofrecemos muchas posibilidades.</p>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-7 align-items-center">
                    <center><img class="img-fluid mb-3 mb-lg-0" src="/assets/img/testimonial2.jpg" alt=""></center>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial3.jpg" class="card-img-top" alt="...">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial4.jpg" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0">Title</h5>
                            <div class="card-text text-black-50">Testimonial</div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial5.jpg" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0">Title</h5>
                            <div class="card-text text-black-50">Testimonial</div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial6.jpg" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0">Title</h5>
                            <div class="card-text text-black-50">Testimonial</div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial7.jpg" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0">Title</h5>
                            <div class="card-text text-black-50">Testimonial</div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <img src="/assets/img/testimonial8.jpg" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0">Title</h5>
                            <div class="card-text text-black-50">Testimonial</div>
                        </div>
