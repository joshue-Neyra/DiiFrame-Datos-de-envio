...
<body>
    ...
    <div class="container card my-5 mb-5">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Diiframe S.A. DE C.V., Calle 23 52, Santa Cruz Aviación, Venustiano Carranza, 15540 Ciudad de México, CDMX, México.</p>
            </li>
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
            <li><strong>Website</strong> refers to Diiframe, accessible from https://diiframe.com.mx/</li>
        ...
        <ul>
            <li>By email: ventas@diiframe.com</li>
            <li>By visiting this page on our website: https://diiframe.com.mx/</li>
        </ul>
    </div>
