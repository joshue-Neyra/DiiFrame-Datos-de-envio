...
$sql = "SELECT dbo.TamanoRelProducto.Tamano_ID, dbo.Productos.Producto_ID, dbo.Productos.Prod_Nombre, dbo.TamanoRelProducto.Precio, dbo.Productos.Familia_ID, dbo.Productos.PrdMeta_ID, dbo.Productos.ID_Status,$Orientacion as Orientacion, 
